...
## ☁️ Como entregar na DIO

**Opção GitHub (recomendada):**
1. Acesse [github.com](https://github.com) e crie um repositório público (ex: `desafios-criativos-ia`).
2. Clique em *Add file* > *Upload files* e envie este arquivo `desafio-criativo-investimentos.md`.
3. Abra o arquivo no repositório, copie a URL e cole no campo de submissão da DIO.

**Opção Google Drive:**
1. Faça upload deste arquivo no seu Google Drive.
2. Clique com o botão direito > *Compartilhar* > *Acesso geral: Qualquer pessoa com o link*.
3. Copie o link e submeta na DIO.
